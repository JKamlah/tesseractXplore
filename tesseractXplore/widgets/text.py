...
The :class:`TextInputOCR` widget provides a box for editable plain text.

Unicode, multiline, cursor navigation, selection and clipboard features
are supported.

The :class:`TextInputOCR` uses two different coordinate systems:
...
To create a multiline :class:`TextInputOCR` (the 'enter' key adds a new line)::

    from kivy.uix.textinput import TextInputOCR
    textinput = TextInputOCR(text='Hello world')

To create a singleline :class:`TextInputOCR`, set the :class:`TextInputOCR.multiline`
property to False (the 'enter' key will defocus the TextInputOCR and emit an
:meth:`TextInputOCR.on_text_validate` event)::

    def on_enter(instance, value):
        print('User pressed enter in', instance)

    textinput = TextInputOCR(text='Hello world', multiline=False)
    textinput.bind(on_text_validate=on_enter)

The textinput's text is stored in its :attr:`TextInputOCR.text` property. To run a
callback when the text changes::

    def on_text(instance, value):
        print('The widget', instance, 'have:', value)

    textinput = TextInputOCR()
...
will be requested::
    ...
    textinput = TextInputOCR(focus=True)
...
:class:`TextInputOCR` inherits, for more details.
...
:attr:`TextInputOCR.selection_text` property.

Filtering
---------

You can control which text can be added to the :class:`TextInputOCR` by
overwriting :meth:`TextInputOCR.insert_text`. Every string that is typed, pasted
or inserted by any other means into the :class:`TextInputOCR` is passed through
...
For example, to write only in capitalized characters::
    ...
    class CapitalInput(TextInputOCR):
...
class TextInputOCRCutCopyPaste(Bubble):
    # Internal class used for showing the little bubble popup when
    # copy/cut/paste happen.

    textinput = ObjectProperty(None)
    ''' Holds a reference to the TextInputOCR this Bubble belongs to.
    '''
    ...
    def __init__(self, **kwargs):
        self.mode = 'normal'
        super(TextInputOCRCutCopyPaste, self).__init__(**kwargs)
    ...
    def on_touch_down(self, touch):
        try:
            ...
            if self.collide_point(*touch.pos):
                FocusBehavior.ignored_touch.append(touch)
            return super(TextInputOCRCutCopyPaste, self).on_touch_down(touch)
        finally:
            touch.pop()
        ...
        try:
            ...
            for child in self.content.children:
                if ref(child) in touch.grab_list:
                    ...
                    break
            return super(TextInputOCRCutCopyPaste, self).on_touch_up(touch)
        finally:
            touch.pop()
...
class TextInputOCR(FocusBehavior, Widget):
    '''TextInputOCR class. See module documentation for more information.
    ...
    .. warning::
        When changing a :class:`TextInputOCR` property that requires re-drawing,
        ...
        :class:`TextInputOCR` that occur between the modification and the next
    ...
    .. Note::
        Selection is cancelled when TextInputOCR is focused. If you need to
        show selection when TextInputOCR is focused, you should delay
    ...
    .. versionchanged:: 1.9.0
        ...
        :class:`TextInputOCR` now inherits from
    ...
    def __init__(self, **kwargs):
        ...
        super(TextInputOCR, self).__init__(**kwargs)
        ...
        _textinput_list.append(ref(self, TextInputOCR._reload_remove_observer))
    ...
    def select_text(self, start, end):
        ''' Select a portion of text displayed in this TextInputOCR.
    ...
    def select_all(self):
        ''' Select all of the text displayed in this TextInputOCR.
    ...
    def on_double_tap(self):
        ...
        inside TextInputOCR. The default behavior is to select the
    ...
    def on_quad_touch(self):
        ...
        inside TextInputOCR. The default behavior is to select all text.
    ...
    def on_touch_down(self, touch):
        ...
        if not self.collide_point(*touch_pos):
            return False
        if super(TextInputOCR, self).on_touch_down(touch):
            return True
    ...
    def _show_cut_copy_paste(self, pos, win, parent_changed=False,
        ...
        bubble = self._bubble
        if bubble is None:
            self._bubble = bubble = TextInputOCRCutCopyPaste(textinput=self)
    ...
    def paste(self):
        ...
        into the :class:`~kivy.uix.textinput.TextInputOCR` at current cursor
        position.
    ...
    def keyboard_on_key_down(self, window, keycode, text, modifiers):
        ...
        if not self.write_tab and super(TextInputOCR,
    ...
    '''If True, the :meth:`TextInputOCR.on_text_validate` event will unfocus the
    widget, therefore make it stop listening to the keyboard. When disabled,
    the :meth:`TextInputOCR.on_text_validate` event can be fired multiple times
    as the result of TextInputOCR keeping the focus enabled.
    ...
    '''Background image of the TextInputOCR when it's not in focus.
    ...
    '''Background image of the TextInputOCR when disabled.
    ...
    '''Background image of the TextInputOCR when it's in focus.
    ...
    Creation of a simple hello world::
        ...
        widget = TextInputOCR(text='Hello world')

    If you want to create the widget with an unicode string, use::

        widget = TextInputOCR(text=u'My unicode string')
    ...
    minimum_height = AliasProperty(_get_min_height,
                                   bind=('_lines', 'line_spacing', 'padding',
                                         ...
                                         'line_height'),
                                   cache=True)
    '''Minimum height of the content inside the TextInputOCR.
    ...
    '''Image used to display the middle handle on the TextInputOCR for cursor
    positioning.
    ...
    '''Image used to display the Left handle on the TextInputOCR for selection.
    ...
    '''Image used to display the Right handle on the TextInputOCR for selection.
    ...
    enter a tab in the :class:`TextInputOCR`. If `True` a tab will be written,
...
''')
            ...
            textinput = TextInputOCR(multiline=True, use_bubble=True,
                                  use_handles=True)
            # textinput.text = __doc__
            root.add_widget(textinput)
            textinput2 = TextInputOCR(multiline=False, text='monoline textinput',
